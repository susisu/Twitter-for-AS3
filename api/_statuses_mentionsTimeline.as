package isle.susisu.twitter.api
{
	...
	public function _statuses_mentionsTimeline(
	...
	):TwitterRequest
	{
		...
		//make request
		var request:TwitterRequest=new TwitterRequest(tokenSet,TwitterURL.statuses_MENTIONS_TIMELINE,URLRequestMethod.GET,parameters);
