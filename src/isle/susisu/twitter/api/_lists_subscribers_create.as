package isle.susisu.twitter.api
{
	...
	public function _lists_subscribers_create(
	...
	):TwitterRequest
	{
		...
		//make request
		var request:TwitterRequest=new TwitterRequest(tokenSet,TwitterURL.lists_subscribers_CREATE,URLRequestMethod.POST,parameters);
