package isle.susisu.twitter.api
{
	...
	public function _lists_members_create(
	...
	):TwitterRequest
	{
		...
		//make request
		var request:TwitterRequest=new TwitterRequest(tokenSet,TwitterURL.lists_members_CREATE,URLRequestMethod.POST,parameters);
