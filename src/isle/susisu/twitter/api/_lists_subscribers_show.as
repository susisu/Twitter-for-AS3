package isle.susisu.twitter.api
{
	...
	public function _lists_subscribers_show(
	...
	):TwitterRequest
	{
		...
		//make request
		var request:TwitterRequest=new TwitterRequest(tokenSet,TwitterURL.lists_subscribers_SHOW,URLRequestMethod.GET,parameters);
