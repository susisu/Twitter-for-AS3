package isle.susisu.twitter.api
{
	...
	public function _lists_members_createAll(
	...
	):TwitterRequest
	{
		...
		//make request
		var request:TwitterRequest=new TwitterRequest(tokenSet,TwitterURL.lists_members_CREATE_ALL,URLRequestMethod.POST,parameters);
